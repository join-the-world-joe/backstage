...
import (
	...
	"backstage/service/oss/api"
	"backstage/service/oss/conf"
	"backstage/service/oss/dispatch"
	"backstage/service/oss/notify"
	"backstage/service/oss/rpc"
	"backstage/service/oss/runtime"
	"bytes"
	"context"
	"encoding/json"
	"errors"
...
func (p *_service) Init() error {
	...
	config2.SetOSSConf(&p.conf.OSSConf)
