...
import (
	...
	"backstage/service/frontend_gateway/agent"
	"backstage/service/frontend_gateway/business"
...
func handler(c *gin.Context) {
	...
	if err != nil {
		log.Error("frontend_gateway.handler.websocket.Upgrader.Upgrade failure, err: ", err.Error())
		return
	}
	...
	if err != nil {
		log.Error("frontend_gateway.handler.business.Logon failure, err: ", err.Error())
		return
	}
	...
	if err != nil {
		log.Error("frontend_gateway.handler.agent.NewAgent failure, err: ", err.Error())
		return
	}
