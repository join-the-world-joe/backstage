...
type Model struct {
	...
	CoverImage    string `gorm:"column:cover_image;type:varchar(100) not null;default:'';comment:封面图" json:"cover_image"`
	FirstImage    string `gorm:"column:first_image;type:varchar(100) not null;default:'';comment:广告首图" json:"first_image"`
	SecondImage   string `gorm:"column:second_image;type:varchar(100) not null;default:'';comment:第二张广告图" json:"second_image"`
	ThirdImage    string `gorm:"column:third_image;type:varchar(100) not null;default:'';comment:第三张广告图" json:"third_image"`
	FourthImage   string `gorm:"column:fourth_image;type:varchar(100) not null;default:'';comment:第四张广告图" json:"fourth_image"`
	FifthImage    string `gorm:"column:fifth_image;type:varchar(100) not null;default:'';comment:第五张广告图" json:"fifth_image"`
	...
	OSSFolder     string `gorm:"column:oss_folder;type:varchar(30) not null;default:'';comment:Image的OSS目录" json:"oss_folder"`
